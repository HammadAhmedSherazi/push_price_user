...
class _VoucherApplyViewState extends State<VoucherApplyView> {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomScreenTemplate(title: "Vouchers and Offers", child: Form(
      key: formKey,
      child: ListView(
      ...
      FocusScope.of(context).unfocus();
          ...
          Consumer(
            builder: (context, ref, child) {
              final isLoad = ref.watch(orderProvider.select((e)=>e.validateVoucherApiResponse.status)) == Status.loading;
              ...
              return  CustomButtonWidget(
                ...
                title: "apply", onPressed: (){
                  ...
                  if (formKey.currentState!.validate()) {
                    ref.read(orderProvider.notifier).validateVoucher(voucherCode: voucherController.text, totalAmount: widget.totalAmount);
                  }
          });
            },
          )
