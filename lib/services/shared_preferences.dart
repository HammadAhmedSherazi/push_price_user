...
class SharedPreferenceManager {
  ...
  List<ProductPurchasingDataModel> getCartList() {
    ...
    return cartJson.map((e) {
      ...
      return ProductPurchasingDataModel.fromJson(json,quantity: json['select_quantity'] ?? 0, discount: json['discountAmount'] ?? 0,store:  StoreDataModel.fromJson(json['store']));
    }).toList();
  }
